...
export default function ProtocolConfigForm({ protocol, config, onChange }: ProtocolConfigFormProps) {
  ...
  return (
    <div className="space-y-4 p-4 bg-page rounded-lg border border-th-default">
      <h4 className="font-semibold text-th-primary flex items-center gap-2">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-[var(--color-input-border)] rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent font-mono text-sm"
            />
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm font-medium text-th-primary">Retain Messages</span>
              </label>
              <p className="text-xs text-th-secondary mt-1">Keep last message on broker</p>
            </div>
          </div>
        </div>
      )}
