  ...
  const navGroups: (NavGroup | NavItem)[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Composite Alerts', href: '/dashboard/composite-alerts' },
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-gray-100 border-r border-gray-300 z-50 flex flex-col overflow-hidden">
      ...
      <div className="px-4 py-4 bg-white border-b border-gray-300">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-gray-900 uppercase tracking-wide leading-tight">Device</p>
            <p className="text-sm font-bold text-gray-900 uppercase tracking-wide leading-tight">Management</p>
          </div>
        </div>
      </div>
      ...
      {/* Footer - Powered by */}
      <div className="px-4 py-3 bg-white border-t border-gray-300 text-center">
