...
**⚠️ Important:** Always review autogenerated migrations! Alembic can miss or misinterpret complex changes.
...
class UserCreate(BaseModel):
    ...
    password: str
    full_name: str
    department: Optional[str] = None  # ← Add field
    role: str = "VIEWER"
```
...
**⚠️ Note:** Pushing to `main` does NOT trigger staging deployment.
...
git checkout staging
git merge main
git push origin staging  # 🚀 Deployment starts!
```
