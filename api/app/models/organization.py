...
from sqlalchemy import Column, String, DateTime, ForeignKey, CheckConstraint, Text, Index
...
class Organization(BaseModel):
    ...
    __table_args__ = (
        ...
        CheckConstraint("status IN ('active', 'inactive', 'suspended')", name="valid_org_status"),
    )
