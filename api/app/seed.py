...
from app.models import Tenant, User, NotificationChannel, NotificationTemplate
...
class DatabaseSeeder:
    ...
    async def _ensure_user(self) -> None:
        ...
        result = await self.db.execute(select(User).where(User.tenant_id == self.tenant_id))
